...
<template>
  ...
  >
    ...
    <div class="w-full md:w-1/3 text-left">
      ...
      >
        Би утасны апп, вебсайт болон програм хөгжүүлэх чадвартай бөгөөд танд
        туслахад бэлэн байна.
      </p>
      <div class="flex justify-center sm:block">
        <a
          download="CV харах"
          href="https://resume.io/r/IlcOnPHGc"
        ...
        >
          ...
          ></i>
          <b class="text-sm sm:text-lg font-general-medium duration-100"
            >CV харах</b
          ></a
        >
